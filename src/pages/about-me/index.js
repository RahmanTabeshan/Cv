        ...
        <div className="flex flex-col gap-y-3 w-full h-full p-5 pr-6 ">
            ...
            <div className="flex flex-col w-full h-full">
                <div className="w-full flex flex-col gap-y-1">
                    <p>سلام.</p>
                    <p>
                        من رحمان تابشان توسعه دهنده فرانت با بیش از 2 سال سابقه آموزش و کار تخصصی در
                        حوزه فرانت و به خصوص ریکت هستم.
                    </p>
                    <p>
                        هر روز و هر لحظه در حال یادگیری ، کار و تمرین با فریمورک ها و کتابخانه های
                        مرتبط با فرانت و به خصوص ریکت هستم.
                    </p>
                    <p>
                        یادگیری و تمرین من در این مسیر در جایی متوقف نخواهد شد و این راه ادامه خواهد
                        داشت .
                    </p>
                </div>
